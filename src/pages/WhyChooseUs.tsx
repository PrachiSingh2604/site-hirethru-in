...
const WhyChooseUs = () => {
  return (
    <>
      <Helmet>
        <title>Why Choose HireThru Consultancy | IT Hiring Excellence</title>
        <meta
          name="description"
          content="HireThru Consultancy combines domain expertise with AI to offer personalized IT hiring solutions. Learn what sets us apart in the recruitment world."
        />
      </Helmet>
