...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>HireThru Consultancy - Connecting Talent</title>
        <meta name="description" content="We are a progressive recruitment firm connecting exceptional talent with forward-thinking companies." />
      </Helmet>
