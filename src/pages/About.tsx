...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - HireThru Consultancy</title>
        <meta
          name="description"
          content="HireThru Consultancy is a trusted recruitment firm specializing in IT/technology, connecting exceptional talent with innovative companies."
        />
      </Helmet>
